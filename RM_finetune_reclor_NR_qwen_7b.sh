...
mkdir -p /root_path/CodePMP/output/RM_finetune_reclor_NR/qwen_7b_Qwen2-7B/eval
...
accelerate launch \
    ...
    --data_path /root_path/CodePMP/data/RM_data/reclor/processed_data_no_repeat \
    --bf16 True \
    --output_dir /root_path/CodePMP/output/RM_finetune_reclor_NR/qwen_7b_Qwen2-7B \
    --dataset_name reclor_NR \
    --num_train_epochs 1 \
    ...
    --run_name RM_finetune_reclor_NR_qwen_7b_Qwen2-7B_${current_datetime} \
    --deepspeed /root_path/CodePMP/config/zero2_config_cf.json \
    --tf32 True && \
python /root_path/CodePMP/RM_evaluate.py \
--model_path /root_path/CodePMP/output/RM_finetune_reclor_NR/qwen_7b_Qwen2-7B \
--data_path /root_path/CodePMP/data/RM_data/reclor/processed_data_no_repeat \
--out_path /root_path/CodePMP/output/RM_finetune_reclor_NR/qwen_7b_Qwen2-7B/eval \
--dataset_name reclor_NR