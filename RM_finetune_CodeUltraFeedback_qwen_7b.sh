...
mkdir -p /root_path/CodePMP/output/RM_finetune_CodeUltraFeedback/qwen_7b_Qwen2-7B/eval
...
accelerate launch \
    ...
    --data_path /root_path/CodePMP/data/RM_data/CodeUltraFeedback_binarized/data \
    --bf16 True \
    --output_dir /root_path/CodePMP/output/RM_finetune_CodeUltraFeedback/qwen_7b_Qwen2-7B \
    --dataset_name CodeUltraFeedback \
    --num_train_epochs 1 \
    ...
    --run_name RM_finetune_CodeUltraFeedback_qwen_7b_Qwen2-7B_${current_datetime} \
    --deepspeed /root_path/CodePMP/config/zero2_config.json \
    --tf32 True && \
python /root_path/CodePMP/RM_evaluate.py \
--model_path /root_path/CodePMP/output/RM_finetune_CodeUltraFeedback/qwen_7b_Qwen2-7B \
--data_path /root_path/CodePMP/data/RM_data/CodeUltraFeedback_binarized/data \
--out_path /root_path/CodePMP/output/RM_finetune_CodeUltraFeedback/qwen_7b_Qwen2-7B/eval \
--dataset_name CodeUltraFeedback