...
mkdir -p /root_path/CodePMP/output/pmp_rm1_lm1_7b_1b_all/qwen_7b
...
--bf16 True \
--output_dir /root_path/CodePMP/output/pmp_rm1_lm1_7b_1b_all/qwen_7b \
--num_train_epochs 1 \
...
--run_name pmp_rm1_lm1_7b_1b_all_qwen_7b_${current_datetime} \
