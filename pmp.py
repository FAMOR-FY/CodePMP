...
def train():
    ...
    if "Gemma2" in config.architectures[0] and trainer.is_world_process_zero():
        with open(os.path.join(training_args.output_dir, 'config.json'), 'r') as file:
            try:
        ...
        with open(os.path.join(training_args.output_dir, 'config.json'), 'w') as file:
